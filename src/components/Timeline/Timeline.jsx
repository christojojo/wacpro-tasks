...
function Timeline() {
  const Timeline = {
    ...
    Departments: [
      { id: "1", dept: "design", progress: "40%", TotalHours: 2000, HoursConsumed: 1200 },
      { id: "2", dept: "Strapi", progress: "6%", TotalHours: 300, HoursConsumed: 212, ApprovedHours: 400, NotApprovedHours: 100 },
      { id: "3", dept: "Python", progress: "24%", TotalHours: 1200, HoursConsumed: 500, NotApprovedHours: 200 },
      { id: "4", dept: "Node", progress: "15%", TotalHours: 750, HoursConsumed: 330, exceed: 400 },
      { id: "5", dept: "Testing", progress: "15%", TotalHours: 750, HoursConsumed: 230 }
    ],
  };
          ...
          <div key={index} className="flex gap-1 pb-4">
            ...
            {data.NotApprovedHours && (
              <div className="not-approved-hrs group relative  bg-[#EA9354] text-[#760000] text-[11px] font-medium leading-[20px] py-1 pl-[6px] h-[28px]" style={{ width: overtime }}>
                <span className="absolute top-1/2 -translate-y-1/2 left-2 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all ease-in-out duration-300 bg-[#F6F6F6] rounded px-[2px]">
                +{data.NotApprovedHours}
                </span>
              </div>
            )}
            {data.exceed && (
              <div className="bg-[#D6D6D6] text-[#515151] text-[11px] font-medium leading-[20px] py-1 pl-[6px] rounded" style={{ width: exceedTime }}>
                +{data.exceed}
              </div>
            )}
            </div>
