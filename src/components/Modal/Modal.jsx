...
function Modal({ModalTitle,ModalContent,ModalWidth}) {
  ...
  return (
    <div className="pt-24">
      <div>
        ...
        {isOpen && (
          <div className={`modal-dialog mx-auto max-w-[${ModalWidth}] w-full border relative rounded z-50 opacity-1 bg-white`}>
